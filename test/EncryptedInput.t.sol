...
contract EncryptedInputTest is Test {
    ...
    function test_Add64Add32_Coprocessor() public {
        ...
        input._signer.coprocSigner.privateKey =
            57345986822467263407452523075989323922629812897950173236713635509495877253377;
        input._signer.kmsSigners = new FFhevm.Signer[](1);
        input._signer.kmsSigners[0].addr = 0x0971C80fF03B428fD2094dd5354600ab103201C5;
        input._signer.kmsSigners[0].privateKey =
            25575929143713252205522749670265078485541952339991649856291280552944085753489;
