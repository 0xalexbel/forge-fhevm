...
import {TFHE, einput, ebool, ebytes256} from "fhevm/lib/TFHE.sol";
...
contract EncryptedInputTest is FhevmTest {
    function test_AsBoolAnd() public {
        ...
        EncryptedInput memory input = fhevm.createEncryptedInput(contractAddress, userAddress);
        ...
        bool b2_ct = fhevm.decryptBool(b2, contractAddress, userAddress);
        bool b3_ct = fhevm.decryptBool(b3, contractAddress, userAddress);
    ...
    function test_helper_AsBytes() public {
        ...
        bytes memory b_ct = fhevm.decryptBytes256(b_enc, contractAddress, userAddress);
    ...
    function test_helper_AsBytesEq() public {
        ...
        bool eq_ct = fhevm.decryptBool(eq_enc, contractAddress, userAddress);
    ...
    function test_Add64Add32_Coprocessor() public {
        ...
        assertEq(einput.unwrap(handles[0]), 0x496eb5b6fa3270a6c5482f4854ea0d8d503e865e528d9d51ed245edd3f000500);
        assertEq(einput.unwrap(handles[1]), 0x46ccfd5cedb24d2a0c6e65c4ec6bd143d0bcf69b197186b79e53452ac5010400);
        assertEq(
            inputProof,
            abi.encodePacked(
