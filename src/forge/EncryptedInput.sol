...
import {einput, Common} from "../debug/fhevm/lib/TFHE.sol";
import {ITFHEDebugger} from "../debug/debugger/interfaces/ITFHEDebugger.sol";
...
import {EncryptedInputList} from "./input/EncryptedInputList.sol";
...
library EncryptedInputLib {
    ...
    function encrypt(EncryptedInput memory self) internal returns (einput[] memory handles, bytes memory inputProof) {
        ...
        ITFHEDebugger db = ITFHEDebugger(self._dbAddress);
