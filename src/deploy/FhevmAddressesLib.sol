...
library FhevmAddressesLib {
    ...
    function _computeCreateAddress(address _origin, uint _nonce) private pure returns (address) {
        bytes memory data;
    ...
    function computeCreateAddress(address _origin, uint _nonce) private pure returns (address) {
    ...
    function expectedCreateACLAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
    ...
    function expectedCreateTFHEExecutorAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
    ...
    function expectedCreateKMSVerifierAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
    ...
    function expectedCreateInputVerifierAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
    ...
    function expectedCreateFHEPaymentAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
    ...
    function expectedCreateGatewayContractAddress(
        address deployerAddr
    ) public pure returns (address expectedImplAddr, address expectedAddr) {
