...
// 3. forge script ./script/DeployFFhevm.s.sol --rpc-url http://127.0.0.1:8545 --broadcast
contract DeployFFhevmScript is Script {
    ...
    function run() public {
        //FFhevmSetUp.setUpFullSuite(deployConfig);
